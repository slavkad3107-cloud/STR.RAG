...
TARGET_SECTIONS: dict[str, dict] = {
    ...
    "OCENKA": {
        # по эталону пользователя («Оценка п. Пересыпь», ФГБУ «Главрыбвод»):
        # ОЦЕНКА = оценка воздействия на водные биоресурсы, не общая ОВОС
        "short": "ОЦЕНКА",
        "name": "Оценка воздействия на водные биологические ресурсы",
