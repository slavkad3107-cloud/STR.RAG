    ...
    for a in (load_answers(q["project"]) or {}).get("answers", []):
        ...
        out.append({k: a.get(k, "") for k in (
            ...
            | {"needs_ai": bool(a.get("needs_ai")),
               ...
               "unsupported_numbers": a.get("unsupported_numbers") or [],
               "shall_unverified": bool(a.get("shall_unverified")),
               "no_change": bool(a.get("no_change")),
               "answer_overclaims": bool(a.get("answer_overclaims")),
               "was_kept_from_previous": bool(a.get("was_kept_from_previous")),
